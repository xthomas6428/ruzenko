...
<div class="tiles mb-4">
    <div class="row">
        <div class="col-6 col-xl-3">
            <a class="card" href="clientarea.php?action=services">
                <div class="media">
                    <i class="shake mr-3 fas fa-box-open green fa-4x"></i>
                    <div class="media-body mt-2">
                        <h5 class="value">{$clientsstats.productsnumactive}</h5>
                        <span class="title">{lang key='navservices'}</span>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-6 col-xl-3">
            <a class="card" href="clientarea.php?action=addfunds">
                <div class="media">
                    <i class="shake mr-3 fas fa-coin yellow fa-4x"></i>
                    <div class="media-body mt-2">
                        <h5 class="value money">{$clientsstats.creditbalance}</h5>
                        <span class="title">{$LANG.invoicescredit}</span>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-6 col-xl-3">
            <a class="card" href="supporttickets.php">
                <div class="media">
                    <i class="shake mr-3 fas fa-user-headset red fa-4x"></i>
                    <div class="media-body mt-2">
                        <h5 class="value">{$clientsstats.numactivetickets}</h5>
                        <span class="title">{lang key='navtickets'}</span>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-6 col-xl-3">
            <a class="card" href="clientarea.php?action=invoices">
                <div class="media">
                    <i class="shake mr-3 fas fa-file-invoice-dollar blue fa-4x"></i>
                    <div class="media-body mt-2">
                        <h5 class="value">{$clientsstats.numunpaidinvoices}</h5>
                        <span class="title">{lang key='navinvoices'}</span>
                    </div>
                </div>
            </a>
        </div>
