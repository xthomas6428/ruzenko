<div class="products-header ark-h mb-5">
    <div class="container">
...
<div class="products-plans">
    <div class="container">
        <h2 class="products-plans-title mb-5">Our <span>ARK: Survival Evolved</span> Server Plans</h2>
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card mb-5">
                    <div class="card-body text-center">
                        <h1 class="pt-3">512MB</h1>
                        <h2>&dollar;0.90 / <span>monthly</span></h2>
                        <ul class="py-3">
                        ...
                        <a href="" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Order now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card card-promo mb-5">
                    <div class="promo-wrapper">
						<div class="ribbon-blue">Popular</div>
					</div>
                    <div class="card-body text-center">
                        <h1 class="pt-3">1GB</h1>
                        <h2>&dollar;1.90 / <span>monthly</span></h2>
                        <ul class="py-3">
                            <li><i class="fas fa-check-circle"></i> 4.4 Ghz CPU Clock Speed</li>
                            <li><i class="fas fa-check-circle"></i> NVMe SSD Storage</li>
                            <li><i class="fas fa-check-circle"></i> Pterodactyl Panel</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card mb-5">
                    <div class="card-body text-center">
                        <h1 class="pt-3">3GB</h1>
                        <h2>&dollar;3.20 / <span>monthly</span></h2>
                        <ul class="py-3">
                            <li><i class="fas fa-check-circle"></i> 4.4 Ghz CPU Clock Speed</li>
                            <li><i class="fas fa-check-circle"></i> NVMe SSD Storage</li>
                            <li><i class="fas fa-check-circle"></i> Pterodactyl Panel</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card mb-5">
                    <div class="card-body text-center">
                        <h1 class="pt-3">6GB</h1>
                        <h2>&dollar;5 / <span>monthly</span></h2>
                        <ul class="py-3">
                            <li><i class="fas fa-check-circle"></i> 4.4 Ghz CPU Clock Speed</li>
                            <li><i class="fas fa-check-circle"></i> NVMe SSD Storage</li>
                            <li><i class="fas fa-check-circle"></i> Pterodactyl Panel</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card mb-5">
                    <div class="card-body text-center">
                        <h1 class="pt-3">8GB</h1>
                        <h2>&dollar;7.50 / <span>monthly</span></h2>
                        <ul class="py-3">
                            <li><i class="fas fa-check-circle"></i> 4.4 Ghz CPU Clock Speed</li>
                            <li><i class="fas fa-check-circle"></i> NVMe SSD Storage</li>
                            <li><i class="fas fa-check-circle"></i> Pterodactyl Panel</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="card mb-5">
                    <div class="card-body text-center">
                        <h1 class="pt-3">12GB</h1>
                        <h2>&dollar;10 / <span>monthly</span></h2>
                        <ul class="py-3">
                            <li><i class="fas fa-check-circle"></i> 4.4 Ghz CPU Clock Speed</li>
                            <li><i class="fas fa-check-circle"></i> NVMe SSD Storage</li>
                            <li><i class="fas fa-check-circle"></i> Pterodactyl Panel</li>
        ...
        <div class="col-lg-6 d-flex align-items-center">
            <div>
                ...
                <ul>
                    <div class="row">
                        <div class="col-lg-6">  
                            <li><i class="fas fa-check"></i> FTP login</li>
                            <li><i class="fas fa-check"></i> Browser file management</li>
                            <li><i class="fas fa-check"></i> Subuser login</li>
                        </div>
                        <div class="col-lg-6">  
                            <li><i class="fas fa-check"></i> Create databases</li>
                            <li><i class="fas fa-check"></i> Restart your server</li>
                            <li><i class="fas fa-check"></i> Console input</li>
                        </div>
                    </div>
                </ul>
            </div>
