                ...
                <div class="col-12 col-sm-6 invoice-col text-center">
                    ...
                    <div class="invoice-status">
                        ...
                        {elseif $status eq "Unpaid"}
                            <span class="btn btn-danger">{lang key='invoicesunpaid'}</span>
                        {elseif $status eq "Paid"}
                            <span class="btn btn-success">{lang key='invoicespaid'}</span>
                        {elseif $status eq "Refunded"}
                            <span class="btn btn-default">{lang key='invoicesrefunded'}</span>
                        {elseif $status eq "Cancelled"}
                            <span class="btn btn-warning">{lang key='invoicescancelled'}</span>
                        {elseif $status eq "Collections"}
                            <span class="btn btn-primary">{lang key='invoicescollections'}</span>
                        {elseif $status eq "Payment Pending"}
                            <span class="btn btn-primary">{lang key='invoicesPaymentPending'}</span>
                        {/if}
                    </div>
